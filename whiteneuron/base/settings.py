...
EMAIL_PORT = 587
EMAIL_HOST_USER = environ.get("EMAIL_HOST_USER", "anhnt@whiteneuron.ai")
EMAIL_ALIAS_USER = environ.get("EMAIL_ALIAS_USER", EMAIL_HOST_USER)
...
######################################################################
# Feature flags (defined before UNFOLD so the sidebar can be built conditionally)
######################################################################
SHOW_FILE_MANAGEMENT = environ.get("SHOW_FILE_MANAGEMENT", "True") == "True"

FILE_MANAGEMENT_ITEMS = [
    {
        "title": _("Excel Files"),
        "icon": "table",
                ...
                [
                    {
                        ...
                        "collapsible": True,
                        "items": FILE_MANAGEMENT_ITEMS,
                    }
                ]
                if SHOW_FILE_MANAGEMENT
                else []
            ),
            {
                "title": _("System"),
                ...
                "items": [
                    ...
                    *(FILE_MANAGEMENT_ITEMS if not SHOW_FILE_MANAGEMENT else []),
                    {
